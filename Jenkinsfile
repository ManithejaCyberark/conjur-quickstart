    ...
    stages{
        ...
        stage("Dev team credentials"){
            steps{
                ...
                withCredentials([conjurSecretCredential(credentialsId: 'Dev-Team-1', variable: 'CONJUR_SECRET')]) {
        ...
        stage("test pipeline cred"){
            steps{
                echo "test-pipeline cred"
                 withCredentials([conjurSecretCredential(credentialsId: '26b3d998-82e3-483d-9880-60ef3f35dd30', variable: 'CONJUR_SECRET')]) {
                  sh 'echo $CONJUR_SECRET | base64'
                }
            }
        }
